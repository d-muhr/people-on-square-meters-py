...
while True: 
    ...
    entity_amount = pyip.inputInt(prompt= '>>> ', min = 10000, max = 1000000000000000)
    ...
    '''
    print("Please decide by how many m² 1", entity, "should be represented (e.g. type '1' for 1 m² per", entity, ").")
    square_meter_per_entity = pyip.inputFloat(prompt= '>>>', min = 1, max = 1000000) 
    
    print("You chose the following:", round(square_meter_per_entity), "m² will represent 1",  entity, "and you want to know how large the area would be for", f"{entity_amount:,}", "of them.")
    ...
    #calculate the amount of times the asked for area fits into the countries and other entities
    '''
    ...
    amount_list = [vatican_city_amount, malta_amount, saarland_amount, mallorca_amount, israel_amount, bavaria_amount, austria_amount, germany_amount, japan_amount, egypt_amount, china_amount, usa_amount, russia_amount, moon_surface_amount, earth_land_surface_amount, earth_water_surface_amount, earth_surface_amount, sun_surface_amount]
    ...
    #create a dictionary in order to use it for the print statements later to have the countries etc. written correctly
    amount_dict = {vatican_city_amount: 'Vatican City', malta_amount: 'Malta', saarland_amount: 'Saarland', mallorca_amount: 'Mallorca', israel_amount: 'Israel', bavaria_amount: 'Bavaria', austria_amount: 'Austria', germany_amount: 'Germany', japan_amount: 'Japan', egypt_amount: 'Egypt', china_amount: 'China', usa_amount: 'the USA', russia_amount: 'Russia', moon_surface_amount: 'the surface of the moon', earth_land_surface_amount: 'the land surface of the earth', earth_water_surface_amount: 'the water surface of the earth', earth_surface_amount : 'the surface of the earth', sun_surface_amount: 'the surface of the sun' }

    #Displaying the user only the appropriate size comparisons:
    counter = 0
    for amount in amount_list:
        if amount >= 0.5 and amount <= 1000:
            print("                -", round(amount, 2), "times the area of", amount_dict[amount], "." )
            counter += 1
